...
public abstract class SetterDefaultArgs {
    ...
    private static Character[] characters = new Character[]{
            new Character(DbIdConstants.ID_TYPE_FASON, "RES", 0f, 3000f, "Результат", "Градус", 1537, 1),
            ...
            new Character(DbIdConstants.ID_TYPE_INGOT, "RES", 0f, 3000f, "Результат", "Градус", 1537, 1),
...
//    };
    ...
    public static void addDefaultData(AppDatabase db){
